...
if __name__ == '__main__':
    ...
    # Save the results
    np.save('results/bilinear_results_singletraj.npy', results_arr)
    print("All tests completed. Results saved to 'results/bilinear_results_singletraj.npy'.")